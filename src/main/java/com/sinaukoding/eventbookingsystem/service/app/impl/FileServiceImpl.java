...
import com.sinaukoding.eventbookingsystem.service.app.FileService;
import com.sinaukoding.eventbookingsystem.util.DateUtil;
...
public class FileServiceImpl implements FileService {
    ...
    public Resource loadFileAsResource(String pathFile) {
        try {
            ...
            if (resource.exists()) {
                ...
                throw new RuntimeException("File : "+pathFile+" not found");
            }
    ...
    private String storeFile(MultipartFile file, TipeUpload tipeUpload) {
        ...
        Checks.isTrue(StringUtils.isNotBlank(originalFilename), "Filename cannot be empty");
        ...
        try {
            ...
            throw new RuntimeException("Failed to upload file : " + fileName + ". Please try again", ex);
        }
    }
}
